...
export default function RoomConf() {
    ...
    return (
        <div className="flex-1 ml-2">
            ...
            <div className="flex justify-between bg-neutral-800/10 space-x-2">
                <div className="flex-none mr-4 mt-2 font-bold text-xl text-amber-400">
                    <p>ROOM</p>
                </div>
                ...
                <div className="flex-1 flex ml-2">
                    <input
                        ...
                        className="outline-none ring-amber-400 ring-2 p-2 px-4 rounded-full flex-1"
                    />
                </div>

                <div className="mx-4 my-2 flex space-x-3 flex-none">
                    <Link href="/admins/create/room">
                    ...
                    <div className="space-y-3">
                        {rooms.map((r: any) => (
                            ...
                            >
                                ...
                                <div onClick={() => router.push(`/admins/update/room?roomId=${r._id}`)}>
                                    ...
                                    <div className="text-sm text-neutral-400">
                                        <p>Number: {r.number}</p>
                                        <p>Total Table: {r.totalTables} tables</p>
                                    </div>
                                </div>
                            </div>
                        ))}
